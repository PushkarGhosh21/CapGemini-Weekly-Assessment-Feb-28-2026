...
import com.springboot2.Exceptions.NotFoundException;
...
public class EmployeeBootService {
	...
	public Employee_boot getById(int id) {
	    return employeebootrepo.findById(id).orElseThrow( () -> new NotFoundException("Employee not found whose id:"+id));
	}
	...
	public Employee_boot updateName(int id, String newName) {
	    ...
	    Employee_boot existingEmployee = employeebootrepo.findById(id).orElseThrow( () -> new NotFoundException("Employee not found whose id:"+id));
